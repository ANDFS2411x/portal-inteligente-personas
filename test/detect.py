...
# CUDA / PyCUDA
import pycuda.autoinit  # Inicializa el driver CUDA
import pycuda.driver as cuda

# ========= Config =========
INPUT_W = 640
INPUT_H = 640
CONF_THRESH = 0.2         # Más alto para reducir falsos positivos
IOU_THRESHOLD = 0.45       # NMS
MIN_BOX_PIXELS = 600       # Filtro por área mínima (ajústalo)
ENGINE_PATH = "../best4_100epocas.engine"
HEADLESS = False           # True = no abre ventana, solo imprime en terminal
OUTPUT_VIDEO = "deteccion_output.avi"  # Nombre del archivo a guardar
        ...
        while True:
            ...
            if len(boxes) == 0:
                ...
                for b, s in zip(boxes, scores):
                    ...
                    print(f" - person ({s:.2f}) box=({x1},{y1},{x2},{y2})")
                    if not HEADLESS:
